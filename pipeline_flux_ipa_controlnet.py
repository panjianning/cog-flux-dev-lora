...
class FluxPipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin):
    ...
    def __call__(
        ...
        if self.controlnet != None and control_image!=None and isinstance(self.controlnet, FluxControlNetModel):
        ...
        elif self.controlnet != None and control_image!=None and isinstance(self.controlnet, FluxMultiControlNetModel):
            control_images = []
            # xlab controlnet has a input_hint_block and instantx controlnet does not
